      ...
      >
        ...
        >
          <Link href="/" className="inline-block">
            <h1 className="text-3xl sm:text-4xl font-bold text-indigo-600 font-serif">Trendix</h1>
          </Link>
        ...
        {error && (
          <motion.div
            ...
            animate={{ opacity: 1, y: 0 }}
            className="mb-6 bg-red-50 border border-red-200 rounded-lg p-3 flex items-center gap-2"
          >
